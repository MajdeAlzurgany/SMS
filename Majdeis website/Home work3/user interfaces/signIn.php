        ...
        <div class="sign-in-form">
            ...
            <form action="../PHPfilse/sign in files/siginin.php" method="post">
                ...
                <label for="sign_in_by" class="sign_in_by">
                    <a href="index.html"><img class="face_signin" src="../Project's Pictures/face.webp" alt="facebook"></a>
                    <a href="index.html"><img class="google_signin" src="../Project's Pictures/google.jpg" alt="google"></a> <br>
                </label>
